...
* **R studio中`Build` button** (**Note：每次更新`_site.yml`后都要`Rebuild Website`**)： 

<img src = "images/build_website.png" style = "width:105%">

* **Log in to GitHub, find the repo, and navigate to settings, 下拉，set the GitHub pages source to the master branch**, 网址就是绿色框中显示的那一串：
